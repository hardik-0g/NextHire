            ...
            <div className="container mx-auto px-4">
                <div className="flex flex-col md:flex-row justify-between items-center">
                    <div className="mb-4 md:mb-0">
                        <h2 className="text-2xl font-bold">NextHire</h2>

                    </div>

                    <div className="flex space-x-4 mt-4 md:mt-0">
                        <a href="https://www.facebook.com/hardik.jaiswal.73550/" className="hover:text-gray-400" aria-label="Facebook">
                        ...
                        <a href="https://x.com/30Hardik" className="hover:text-gray-400" aria-label="Twitter">
                        ...
                        <a href="https://www.linkedin.com/in/hardikjaiswal9580100/" className="hover:text-gray-400" aria-label="LinkedIn">
                ...
                <div className='text-center mb-0'>
                    <p className="text-sm">© 2026 NextHire. Made with Love ❤️.</p>
                </div>
            </div>
        </footer>
    );
